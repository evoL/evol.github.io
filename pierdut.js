...
(function() {
  ...
  Bounds = (function() {
    function Bounds(_at_left, _at_right, _at_top, _at_bottom) {
      this.left = _at_left;
  ...
  Renderer = (function() {
    function Renderer(_at_size, _at_context) {
      var pixbuf;
      this.size = _at_size;
  ...
  Formula = {
    ...
    Branched: function(params, x, y) {
      ...
      if (Math.random() < params[8]) {
        ...
        nx = y + params[4] * ((_ref = x >= 0) != null ? _ref : {
          1: -1
        }) * Math.sqrt(Math.abs(params[5] * x - params[6]));
      }
      if (Math.random() < params[8]) {
  ...
  verifyAttractor = function(attractor) {
    var distance, dx, dy, ep, i, lyapunov, startdistance, v1, ve, _i;
    lyapunov = 0;
    v1 = {
      x: Math.random() * 4 - 2,
      y: Math.random() * 4 - 2
  ...
  Reactor = (function() {
    function Reactor(_at_attractor, options) {
      this.attractor = _at_attractor;
      if (options == null) {
        options = {};
      }
